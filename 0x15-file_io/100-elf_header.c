...
/**
 * print_elf_osabi - Prints an ELF header OS/ABI.
...
/**
 * print_abi_version - Prints an ELF header ABI version.
...
/**
 * print_file_type - Prints ELF header type.
 * @e_type: ELF type.
...
/**
 * print_entry_point - Prints ELF header entry point.
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	print_file_data(header->e_ident);
